...
Public Class MPInventario
    ...
    Private Sub DVOC_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DVOC.CellContentClick
        ...
        If TxtCS.Text = Fal And LKGS.Text = "TON" Then
            Dim P = (CDec(TxtCS.Text) * 1000)
            TxtCR.Text = P - Fal
        ElseIf LKGS.Text = "TON" Then
            Dim P = (CDec(TxtCS.Text) * 1000)
            TxtCR.Text = P - Fal
        Else
            TxtCR.Text = CDec(TxtCS.Text) - Fal
        End If
    ...
    Private Sub TxtBOC_TextChanged(sender As Object, e As EventArgs) Handles TxtBOC.TextChanged
        ...
        Else
            Dim Consulta As String = "SELECT OC.id_orden, OC.purchase_order, OC.codigo, P.nombre, OD.cantidad,
                                                OD.Um, OC.CodiS, OD.descripcion, OD.id_pro, IsNull(Od.estatus, 0) AS Faltante
