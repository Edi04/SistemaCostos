...
Public Class Pedidos1
    ...
    Sub combo_productos1() 'combo para mostrar los productos
        ...
        conexxo.Open()
        comando = New SqlCommand("select * from TB_Productos where Estado='Activo' Or Estado = 'MPActivo' or Estado ='AMass' or Estado = 'MaqActivo' ORDER BY Nombre_Producto asc", conexxo)
        adaptador = New SqlDataAdapter(comando)
        tabla = New DataTable()
        adaptador.Fill(tabla)
        '-------PRODUCTO 1 --------------
    ...
    Private Sub PictureBox5_Click(sender As Object, e As EventArgs) Handles PictureBox5.Click
        If MessageBox.Show("Estas Seguro Que Quieres Agregar " + TextCodigo.Text, "Nueva Orden De Compra", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) = DialogResult.OK Then
            '---------------comiienza codigo
    ...
    '--------------Validaciones-----------------
    Private Sub TextQuantity1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity1.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity2.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity3_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity3.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity4_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity4.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity5_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity5.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity6_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity6.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity7_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity7.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity8_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity8.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity9_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity9.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity10_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity10.KeyPress
        SoloNumeros(e)
    End Sub
    ...
    Private Sub TextQuantity11_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity11.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity12_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity12.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity13_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity13.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity14_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity14.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity15_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity15.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity16_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity16.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity17_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity17.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity18_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity18.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity19_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity19.KeyPress
        SoloNumeros(e)
    End Sub

    Private Sub TextQuantity20_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextQuantity20.KeyPress
        SoloNumeros(e)
    End Sub
