...
Public Class Compra_Conbustible
    ...
    End Sub
    '-----------------------------------------trmina botonera------------------------------
    Private Sub Compra_Conbustible_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        If MessageBox.Show("Estas Seguro Que Quieres Agregar Mas Combustible", "Mas Combustible", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) = DialogResult.OK Then
            Try
                ...
                logica.Con_mpn = Me.ComboBox_pmn.Text

                If funciones.FN_InsertarConbustible(logica) Then
                    MsgBox("Combustible Agregado Correctamente", MessageBoxIcon.Information)
                    Generar_Codigo_Combustimble()
                    Reparticion_gasolina.gasolina_premium_actual()
                    Reparticion_gasolina.gasolina_magna_actual()
                    Reparticion_gasolina.diesel_actual()
                End If
        ...
        Try
            ...
            With openFD
                ...
                If .ShowDialog = Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pathDefinitivo As String = "\\ANTUA-PC\Servidor_de_Archivos\Comprobantes_Combustible\Compras_Grandes"
    ...
    Sub Generar_Codigo_Combustimble()
        ...
        Dim cmd As New SqlCommand("select MAX(id_con)from TB_Combustible_Comprado", conexxo)
        ...
        codigo_combus.Text = "Comb-" + Format(id + 1, "0000") + "/20"
    End Sub
    '-----------------------------------------------------------------------------------------
