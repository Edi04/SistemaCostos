...
Public Class Tickets
    ...
    Private Sub Datos(ByVal sender As System.Object, ByVal e As PrintPageEventArgs)
        ...
        For Each row As DataGridViewRow In Me.DatosDG.Rows
            ...
            e.Graphics.DrawString(LProveedor.Text.Trim, New Font("Consolas", 10), Brushes.Black, 10, 180 + T)
            e.Graphics.DrawString(TxtProveedor.Text.PadLeft(10), New Font("Consolas", 8), Brushes.Black, 30, 192 + T)
        Next
    End Sub
    ...
    Private Sub Proveedores()
        ...
        Comando = New SqlCommand("SELECT *
                                  FROM Tb_Proveedores 
                                  ORDER BY Nombre ASC", Conex)
        Adaptador = New SqlDataAdapter(Comando)
        Tabla = New DataTable()
        Adaptador.Fill(Tabla)

        '-------Area--------------
        CProveedor.DataSource = Tabla
        CProveedor.DisplayMember = "Nombre"
        CProveedor.ValueMember = "id_p"
    End Sub
