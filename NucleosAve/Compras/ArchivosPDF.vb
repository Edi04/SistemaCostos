...
Public Class ArchivosPDF
    ...
    Private Sub ArchivosPDF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ':::Capturador de errores Try
        Try
            ':::Contamos cuanto archivos de texto hay en la carpeta
            Dim Total = My.Computer.FileSystem.GetFiles("\\ANTUA-PC\Servidor_de_Archivos\Documentos\PDF", FileIO.SearchOption.SearchAllSubDirectories, "*.pdf")
            LblTotal.Text = "N# Facturas PDF: " + CStr(Total.Count)

            ':::Realizamos la búsqueda de la ruta de cada archivo de texto y los agregamos al ListBox
            For Each archivos As String In My.Computer.FileSystem.GetFiles("\\ANTUA-PC\Servidor_de_Archivos\Documentos\PDF", FileIO.SearchOption.SearchAllSubDirectories, "*.pdf")
    ...
    Private Sub descargapdf_Click(sender As Object, e As EventArgs) Handles descargapdf.Click
        Try
            Dim direccion As String
            direccion = directoriotxt.Text
            My.Computer.FileSystem.CopyFile(direccion, "C:\Archivos\PDF\Factura.pdf", Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, Microsoft.VisualBasic.FileIO.UICancelOption.DoNothing)
