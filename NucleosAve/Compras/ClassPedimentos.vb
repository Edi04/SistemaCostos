Public Class ClassPedimentos
    Dim fecha As Date
    Dim id As Integer
    Dim cove, codigo_pedimento, orden_compra, pedimento, clave, aduana, tipo, t_cantidad, id_provedor, unidad, id_factura, estado, codigobueno As String
